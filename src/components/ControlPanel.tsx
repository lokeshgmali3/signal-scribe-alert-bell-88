...
const ControlPanel = ({
  ...
  return <div className="bg-card p-4 py-[4px]">
      <div className="grid grid-cols-4 gap-4 max-w-2xl mx-auto">
        ...
        <Button onClick={handleSaveClick} variant="default" className={`h-16 flex flex-col gap-1 transition-transform duration-200 select-none bg-primary text-primary-foreground hover:bg-primary focus:bg-primary active:bg-primary ${saveButtonPressed ? 'scale-95' : ''} ${!signalsText.trim() ? 'opacity-50 cursor-not-allowed' : ''}`} disabled={!signalsText.trim()} style={{
        userSelect: 'none',
        WebkitUserSelect: 'none'
      }}>
        ...
        <Button onClick={onScreenOff} variant="secondary" className="h-16 flex flex-col gap-1 transition-transform duration-200 select-none" style={{
        userSelect: 'none',
        WebkitUserSelect: 'none'
      }}>
        ...
        <Button variant="outline" className={`h-16 flex flex-col gap-1 transition-transform duration-200 select-none hover:bg-background focus:bg-background active:bg-background ${saveTsButtonPressed ? 'scale-95' : ''}`} style={{
        userSelect: 'none',
        WebkitUserSelect: 'none'
